 ...
 */
@Embeddable
public class TiposPlantasPK implements Serializable {
    ...
    public TiposPlantasPK() {
    }

    public TiposPlantasPK(String nombreCientifico, String nombreComun) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TiposPlantasPK)) {
            return false;
        }
        TiposPlantasPK other = (TiposPlantasPK) object;
    ...
    public String toString() {
        return "grupo6.DP.TiposPlantasPK[ nombreCientifico=" + nombreCientifico + ", nombreComun=" + nombreComun + " ]";
    }
